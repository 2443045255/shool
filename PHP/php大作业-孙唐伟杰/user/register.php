  ...
  <div class="container">
    <ul>
      ...
      <li class="line line-input">
        ...
        <input id="username" type="text" name="username" autocomplete="off" value="123">
      </li>
      <li class="line line-input">
        <span class="title">密码:</span>
        <input id="password" type="text" name="password" autocomplete="off" value="1234">
      </li>
      <li class="line line-input">
        <span class="title">确认密码:</span>
        <input id="two_password" type="password" name="re_password" value="1234">
      </li>
      <li class="line">
